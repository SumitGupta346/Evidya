...
session_start();
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <h3 class="mb-5">Welcome to E-Vidya Payment Page</h3>
    <form method="post" action="./PaytmKit/pgRedirect.php" id="myform">
      <div class="form-group row">
       <label for="ORDER_ID" class="col-sm-4 col-form-label">Subscribe ID</label>
       <div class="col-sm-8">
      ...
      <div class="text-center">
        ...
        <input type="submit"  value="Check out" class="btn btn-secondary" onclick="">
