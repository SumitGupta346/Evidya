...
<div class="vid-content">
  <h1 class="my-content">Welcome to E-Vidya</h1>
  <small class="my-content">Learn and Implement</small><br>

  <?Php
    if(!isset($_SESSION['is_login'])){
      echo '<a href="#" class="btn btn-warning mt-3" data-toggle="modal" data-target="#stuRegModalCenter">Get Started</a>';
    } else{
      echo '<a href="student/studentProfile.php" class="btn btn-warning mt-3" >My Profile </a>';
    }
    ?>
...
<!-- End Contact Us -->
   ...
   <div class="container-fluid mt-5" style="background-color: #4B7289" id="Feedback">
        <h1 class="text-center testyheading p-4"> Student's Reviews </h1>
        <div class="row">
          <div class="col-md-12">
 ...
 <div class="container-fluid p-4" style="background-color:#E9ECEF">
  <div class="container" style="background-color:#E9ECEF">
    <div class="row text-center">
      <div class="col-sm">
        <h5>About Us</h5>
          <p>E-Vidya provides universal access to best education, partnering with top universities and organizations to offer courses online.</p>
      </div>
      <div class="col-sm">
        <h5>Category</h5>
      ...
      <div class="col-sm">
        <h5>Contact Us</h5>
        <p> E-Vidya Pvt Ltd <br> 
          Banashankari Stage III, Dwaraka Nagar, <br> Bengaluru, Karnataka <br> Ph. 000000000 </p>
      </div>
    </div>
  </div>
